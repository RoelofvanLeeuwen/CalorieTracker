...
|----------|--------|---------------|
| UX-005 — Verwijderen consumptie en activiteiten | In ontwikkeling | Testen in browser, daarna PR naar development |
...
UX-005 testen in browser aan de hand van de acceptatiescenario's. Na goedkeuring PR aanmaken naar development.
